...
argument-hint: "[budget en mots, défaut 120]"
---

Budget demandé : `$1` mots. Quand `$1` est vide, prends 120.

## Portée du verrou

Applique la contrainte à toutes tes réponses suivantes, jusqu'à `/massdo-skills:answer-short:reset`. Si l'utilisateur demande de développer un point, développe-le, puis reprends le format court.
